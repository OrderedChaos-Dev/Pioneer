package pioneer.common.world.features.tree.foliageplacers;
...
public class PalmFoliagePlacer extends FoliagePlacer {
	...
	protected FoliagePlacerType<?> type() {
		return PioneerTreePlacers.Foliage.PALM_FOLIAGE_PLACER.get();
	}

	@Override
	public int foliageHeight(RandomSource p_230374_1_, int p_230374_2_, TreeConfiguration config) {
		return 3;
	}
