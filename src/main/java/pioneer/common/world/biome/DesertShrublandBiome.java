...
public class DesertShrublandBiome {
	...
	public static Biome desertShrubland() {
		...
		PioneerBiomeFeatures.addDesertShrublandVegetation(biomeGenSettings);
		
		MobSpawnSettings.Builder mobSpawnSettings = new MobSpawnSettings.Builder();
		BiomeDefaultFeatures.desertSpawns(mobSpawnSettings);

	    return BiomeUtils.biome(Biome.Precipitation.NONE, 2.0F, 0F, 4159204, 329011, mobSpawnSettings, biomeGenSettings, null);
	}
