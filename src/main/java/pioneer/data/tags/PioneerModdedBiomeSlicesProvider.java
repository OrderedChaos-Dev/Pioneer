...
//	//temperatures
//	private final Climate.Parameter COLD = span(-1.0F, -0.45F); //snowy tundra, snowy taiga
//	private final Climate.Parameter COOL = span(-0.45F, -0.15F); //plains, forest, taiga
//	private final Climate.Parameter WARM = span(-0.15F, 0.2F); //plains, forest, dark forest
//	private final Climate.Parameter HOT = span(0.2F, 0.55F); //savanna, jungle, forest
//	private final Climate.Parameter MY_GF = span(0.55F, 1.0F); //desert, jungle, mesa (high continentalness + low erosion)
//
//	//humidity
//	private final Climate.Parameter SUPER_DRY = span(-1.0F, -0.35F); //snowy tundra, plains, savanna, desert
//	private final Climate.Parameter DRY = span(-0.35F, -0.1F); //snowy tundra, plains, savanna, desert
//	private final Climate.Parameter NORMAL = span(-0.1F, 0.1F); //snowy taiga, forest, desert
//	private final Climate.Parameter WET = span(0.1F, 0.3F); //taiga, birch forest, jungle
//	private final Climate.Parameter VERY_WET = span(0.3F, 1.0F); //giant spruce taiga, dark forest, jungle
//
//	//continentalness
//	private final Climate.Parameter MUSHROOM_ISLANDS = span(-1.2F, -1.05F);
//	private final Climate.Parameter DEEP_OCEAN = span(-1.05F, -0.455F);
//	private final Climate.Parameter OCEAN = span(-0.455F, -0.19F);
//	private final Climate.Parameter COASTAL = span(-0.19F, -0.11F);
//	private final Climate.Parameter INLAND = span(-0.11F, 0.55F);
//	private final Climate.Parameter NEAR_INLAND = span(-0.11F, 0.03F);
//	private final Climate.Parameter MID_INLAND = span(0.03F, 0.3F);
//	private final Climate.Parameter FAR_INLAND = span(0.3F, 1.0F);
//	
//	//erosions
//	private final Climate.Parameter ERODED_0 = span(-1.0F, -0.78F);
//	private final Climate.Parameter ERODED_1 = span(-0.78F, -0.375F);
//	private final Climate.Parameter ERODED_2 = span(-0.375F, -0.2225F);
//	private final Climate.Parameter ERODED_3 = span(-0.2225F, 0.05F);
//	private final Climate.Parameter ERODED_4 = span(0.05F, 0.45F);
//	private final Climate.Parameter ERODED_5 = span(0.45F, 0.55F);
//	private final Climate.Parameter ERODED_6 = span(0.55F, 1.0F);
//	
//	//depth
//	private final Climate.Parameter SURFACE = Climate.Parameter.point(0.0F);
//	private final Climate.Parameter CAVE = Climate.Parameter.span(0.3F, 0.9F);
//
//	@Override
//	//temperature, humidity, continentalness, erosion, depth, weirdness, long offset)
//	protected void registerSlices() {
//		Climate.Parameter zero = Climate.Parameter.point(0.0F);
//		Registry<Biome> biomes = RegistryAccess.BUILTIN.get().registryOrThrow(Registry.BIOME_REGISTRY);
//		
//		this.registerSlice(
//				"verdant_sands",
//				5,
//				new BiomeUtil.MultiNoiseModdedBiomeProvider(
//						new Climate.ParameterList<>(List.of(
//								Pair.of(Climate.parameters(MY_GF, DRY, INLAND, ERODED_5, zero, zero, 0.0F),
//										BlueprintBiomes.ORIGINAL_SOURCE_MARKER.getKey()),
//								Pair.of(Climate.parameters(zero, DRY, MID_INLAND, zero, zero, zero, 0.0F), PioneerBiomes.VERDANT_SANDS.getKey())))),
//				overworld);
//	}
	...
	protected void registerSlices() {
		...
		new BiomeBuilder().addBiomes(pair -> builder.add(pair));
		this.registerSlice("pioneer_modded_slice", 10, new BiomeUtil.MultiNoiseModdedBiomeProvider(new Climate.ParameterList<>(builder.build())), OVERWORLD);
	}
