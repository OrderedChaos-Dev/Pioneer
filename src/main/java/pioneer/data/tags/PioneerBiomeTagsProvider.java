...
public class PioneerBiomeTagsProvider extends BiomeTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BiomeTags.HAS_PILLAGER_OUTPOST).add(PioneerBiomes.BAOBAB_FIELDS.getKey(), PioneerBiomes.PINE_MEADOWS.getKey(), PioneerBiomes.VERDANT_SANDS.getKey(), PioneerBiomes.PRAIRIE.getKey());
		...
		this.tag(BiomeTags.HAS_VILLAGE_DESERT).add(PioneerBiomes.DESERT_SHRUBLAND.getKey(), PioneerBiomes.VERDANT_SANDS.getKey());
