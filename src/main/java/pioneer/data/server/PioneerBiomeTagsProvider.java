...
public class PioneerBiomeTagsProvider extends BiomeTagsProvider {
	...
	public void addTags() {
		...
		this.tag(BiomeTags.IS_MOUNTAIN).add(PioneerBiomes.OVERGROWN_SPIRES.getKey(), PioneerBiomes.WINDSWEPT_CLIFFS.getKey());
		...
		addTags(PioneerBiomes.VERDANT_SANDS.getKey(), BiomeTags.IS_SAVANNA, Tags.Biomes.IS_SANDY, Tags.Biomes.IS_LUSH, Tags.Biomes.IS_HOT, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_HOT, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_DENSE, Tags.Biomes.IS_DENSE_OVERWORLD, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.PINE_MEADOWS.getKey(), Tags.Biomes.IS_PLAINS, Tags.Biomes.IS_CONIFEROUS, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.AUTUMNAL_CONIFEROUS_FOREST.getKey(), Tags.Biomes.IS_COLD, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.BOREAL_FOREST.getKey(), Tags.Biomes.IS_COLD, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.SNOWY_BOREAL_FOREST.getKey(), Tags.Biomes.IS_COLD, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS, Tags.Biomes.IS_SNOWY, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.DESERT_SHRUBLAND.getKey(), Tags.Biomes.IS_DRY, Tags.Biomes.IS_DRY_OVERWORLD, Tags.Biomes.IS_HOT, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_SANDY, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.OVERGROWN_SPIRES.getKey(), Tags.Biomes.IS_WET, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_LUSH, Tags.Biomes.IS_HOT, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_DENSE, Tags.Biomes.IS_DENSE_OVERWORLD, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.PRAIRIE.getKey(), Tags.Biomes.IS_PLAINS, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.REDWOODS.getKey(), Tags.Biomes.IS_COLD, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.SNOWY_BOREAL_FOREST.getKey(), Tags.Biomes.IS_SNOWY, Tags.Biomes.IS_COLD, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.BAOBAB_FIELDS.getKey(), BiomeTags.IS_SAVANNA, Tags.Biomes.IS_HOT, Tags.Biomes.IS_HOT_OVERWORLD, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.CRYSTAL_LAKES.getKey(), Tags.Biomes.IS_WET, Tags.Biomes.IS_WET_OVERWORLD, Tags.Biomes.IS_COLD, Tags.Biomes.IS_COLD_OVERWORLD, Tags.Biomes.IS_CONIFEROUS, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.BLOSSOMING_FIELDS.getKey(), Tags.Biomes.IS_PLAINS, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.ASPEN_GROVE.getKey(), Tags.Biomes.IS_COLD, Tags.Biomes.IS_COLD_OVERWORLD, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.RED_ROCK_CANYON.getKey(), Tags.Biomes.IS_LUSH, Tags.Biomes.IS_HOT, Tags.Biomes.IS_HOT_OVERWORLD, Tags.Biomes.IS_SANDY, Tags.Biomes.IS_DRY, Tags.Biomes.IS_DRY_OVERWORLD, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.FLOODED_FOREST.getKey(), Tags.Biomes.IS_LUSH, Tags.Biomes.IS_WET, Tags.Biomes.IS_WET_OVERWORLD, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.WINDSWEPT_CLIFFS.getKey(), Tags.Biomes.IS_PEAK, BiomeTags.IS_OVERWORLD);
		addTags(PioneerBiomes.WILLOW_WETLANDS.getKey(), Tags.Biomes.IS_SWAMP, Tags.Biomes.IS_WET, Tags.Biomes.IS_WET_OVERWORLD, BiomeTags.IS_OVERWORLD);
	};
